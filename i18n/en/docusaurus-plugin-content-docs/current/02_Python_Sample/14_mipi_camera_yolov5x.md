...
- For MIPI camera installation instructions, refer to the section [Camera Expansion Board – MIPI Camera Interface](https://developer.d-robotics.cc/rdk_s100_os_doc/en/Quick_start/hardware_introduction/rdk_s100_camera_expansion_board).
